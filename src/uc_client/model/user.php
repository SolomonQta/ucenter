...
class usermodel {
	...
	function add_user($username, $password, $email, $uid = 0, $questionid = '', $answer = '', $regip = '') {
		...
		// BEGIN
		$this->db->query("INSERT INTO ".DISCUZ_DBTABLEPRE."member SET uid='$uid', username='$username', password='$password', email='$email', adminid='0', groupid='9', regdate='".$this->base->time."', credits='0', timeoffset='9999'");
